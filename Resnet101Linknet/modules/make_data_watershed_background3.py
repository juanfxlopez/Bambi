...
for n, id_ in tqdm(enumerate(train_ids), total=len(train_ids)):
    ...
    for mask_file in next(os.walk(path+"/masks/"))[2]:
        ...
        maskita_inv=cv2.bitwise_not(maskita,cv2.THRESH_BINARY)
    ...
    mask_labelinter_inv = Image.fromarray(maskita_inv)
    ...
    mask_labelinter_inv.save("../data/GenData/TrainData/labels_inter_inv/" + str("%04d" % (n + 794)) + "_.png")
