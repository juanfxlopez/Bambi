...
class DatasetCells(Dataset):
    ...
    """
    def __init__(self,file_data_idx, file_label_idx, file_inter_idx,  transform=None, mode="train"):
...
def CellTrainData(data_transform=None, mode="train"):
    ...
    dataset = DatasetCells(file_idxs, label_idxs, inter_idx, transform=data_transform, mode=mode)
    return dataset
...
def CellDataLoader(data_transform=None, mode="train", batch_sz=2, workers=1):
    ...
    dataset = DatasetCells(file_idxs, label_idxs, inter_idxs, transform=data_transform, mode="train")
